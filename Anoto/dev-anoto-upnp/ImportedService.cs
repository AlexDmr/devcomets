...
namespace Intel.DeviceBuilder
{
    ...
    public class ImportedService : IUPnPService
    {
        ...
        public void getTcpServer(out System.String a)
        {
            ...
            a =  (System.String) _S.GetStateVariable("tcpAdress");
        }
        /// <summary>
        /// Action: setForce
        /// </summary>
